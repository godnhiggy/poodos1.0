...
<br><br>
  ...
  //echo "<label for='printQR'> <a href='printQR.php' >    <p>Some text..</p>Print QR Labels</a></label><br>";
//}
...
if($currentBoxNumberConfirmed="yes" && $prepCurrent =="2" && $printQRCurrent =="2" && $foldersCurrent =="2"){
  ...
  ?>
  <br><br>
  <form action="docIndexAction.php" method="POST">
  <input type='checkbox' name='docIndex' value='2'>
  <label for='docIndex'> Document Indexing</label><br>
