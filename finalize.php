...
if($currentBoxNumberConfirmed!=="yes" || $prepCurrent !=="2" || $printQRCurrent !=="2" || $foldersCurrent !=="2" || $docIndexCurrent !=="2" || $qaCurrent !=="2"){
...
//}
if($currentBoxNumberConfirmed="yes" && $prepCurrent =="2" && $printQRCurrent =="2" && $foldersCurrent =="2"){
  //header("Location: folders.php");
  echo "All Folders Scanned<br>";
}

if($currentBoxNumberConfirmed="yes" && $prepCurrent =="2" && $printQRCurrent =="2" && $foldersCurrent =="2" && $docIndexCurrent =="2"){
  //header("Location: folders.php");
  echo "All Documents Indexed<br>";
}
...
if($currentBoxNumberConfirmed="yes" && $prepCurrent =="2" && $printQRCurrent =="2" && $foldersCurrent =="2" && $docIndexCurrent =="2" && $qaCurrent =="2"){
  ...
  ?>
  <br><br>
  <form action="finalizeAction.php" method="POST">
  <input type='checkbox' name='finalize' value='2'>
  <label for='finalize'> Finalize </label><br>
